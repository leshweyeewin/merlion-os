...
| 🔔 **Watchlists & ScamShield** | Proactive trigger alerts (COE drop, BTO launch, resale shift, tax deadline, MRT delay) via Telegram/WhatsApp/Web Push, and Community ScamShield phishing checker. | [docs/watchlists_and_scamshield.md](docs/watchlists_and_scamshield.md) |
| 🤖 **Co-Pilot & Document Copilot** | Gemini multimodal vision, PDF PII redaction pipeline, synthetic mock statement generators, persona profiles, and WhatsApp simulator. | [docs/copilot_guide.md](docs/copilot_guide.md) |
